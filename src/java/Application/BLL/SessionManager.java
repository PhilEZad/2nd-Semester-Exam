...
public class SessionManager
{
    ...
    public static boolean tryBeginSession(AccountType type, String username, String password) throws InvalidClassException
    {
        Account account = new AccountDAO().read(username);

        if (account != null && account.getAuthorization() == type.getId() && account.getPassword().equals(createToken(username, password)))
        {
